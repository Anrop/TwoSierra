...
ADF_CAS_vehClass		= "sfp_jas39"; // classname of CAS aircraft
...
ADF_CAS_station		= "OSCAR"; // ingame name of the CAS station call
ADF_CAS_targetName	= "ELVIS"; // ingame name of OpFor. E.g. TANGO, CSAT, etc.
