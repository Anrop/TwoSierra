...
_ADF_Caching_unitDistance = 750; // AI Unit caching distance default = 1000 meters.
...
/********** VIEW DISTANCE **********/
setViewDistance 600; // Default view distance.
ADF_VD_foot = 600; // Maximum view distance on foot.
ADF_VD_vehicle = 600; // Maximum view distance in a vehicle.
